...
impl Handshake {
    ...
    pub fn generate_outbound_p0_and_p1(&mut self) -> Result<Vec<u8>, HandshakeError> {
        ...
        self.sent_p1[(digest_offset as usize)..(digest_offset as usize + SHA256_DIGEST_LENGTH)]
            .clone_from_slice(&self.sent_digest[..SHA256_DIGEST_LENGTH]);
    ...
    fn parse_p1(&mut self) -> Result<HandshakeProcessResult, HandshakeError> {
        ...
        output_packet[P2_SIG_START_INDEX..(P2_SIG_START_INDEX + SHA256_DIGEST_LENGTH)]
            .clone_from_slice(&hmac2[..SHA256_DIGEST_LENGTH]);
...
fn calc_hmac_from_parts(part1: &[u8], part2: &[u8], key: &[u8]) -> [u8; SHA256_DIGEST_LENGTH] {
    ...
    inputs.extend_from_slice(part1);
    inputs.extend_from_slice(part2);
...
fn calc_hmac(input: &[u8], key: &[u8]) -> [u8; SHA256_DIGEST_LENGTH] {
    ...
    let array = <[u8; SHA256_DIGEST_LENGTH]>::from(result.into_bytes());

    if array.len() != SHA256_DIGEST_LENGTH {
        panic!(
